...
class Minigrid:
    def __init__(self, env_name, realtime_mode = False):
        ...
        self.render_mode = "human" if realtime_mode else "rgb_array"
            
        self._env = gym.make(env_name, agent_view_size = 3, tile_size=28, render_mode=self.render_mode)
    ...
    # def set_wrapper_attr(self, key, value):
        # self._env.set_wrapper_attr(key, value)