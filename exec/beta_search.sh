...
#SBATCH -o slurm/search_%j.out
#SBATCH -e slurm/search_%j.%N.err
#SBATCH --gres=gpu:1
...
DEVICE="gpu"
SEED=42  # Only one seed needed for structural stability checks
...
BETA_C=(0.01 0.1)  # Kept smaller due to massive chunk penalties
CHUNK_C=(6000)
