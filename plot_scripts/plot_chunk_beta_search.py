...
def main():
    ...
    plt.savefig('visualizations/beta_chunksize_search.png', bbox_inches='tight')
    plt.savefig('visualizations/beta_chunksize_search.pdf', bbox_inches='tight')
    print("Saved plots as 'visualizations/beta_chunksize_search.*'.")
