...
The result is $72.2\%$ average accuracy and $\mathrm{BWT} = -0.070$.

\paragraph{Gradient-only normalization.}
Applying unit-$\ell_2$ column normalization to $G$ alone recovers $68.9\%$ (BWT $-0.060$), below both full normalization ($86.0\%$) and the no-normalization baseline ($72.2\%$) (Figure~\ref{fig:norm_ablation}).
...
Average accuracy recovers to $86.0\%$ and BWT improves to $-0.013$ (Figure~\ref{fig:norm_ablation}).
