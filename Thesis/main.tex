...
\clearpage
\section{Appendix}
\input{appendix/proof_ifopng.tex}

\input{appendix/standalone_targetnetwork.tex}

\input{appendix/additional_experiments.tex}

\input{appendix/full_benchmark.tex}

\input{appendix/hyper_parameters.tex}


% REMEMBER TO ADD OSWALD COMING UP WITH HIS REGULIZER AFTER UNDERSTANDING EWC. HYPERREGULIZER = EWC FOR META CHUNKING

% ALSO FIGURE OUT THE DROPOUT REMOVAL. MAYBE ITS GOOD RN

% EMPHASIZE THE COMPRESSION OF HYPERNETWORKS AND HOW IMPRESIVE IT IS. THERE IS A PLOT HYPERNETWORK-TRAJECTORY...
\end{document}