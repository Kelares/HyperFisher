...
% REPLACE: "This appendix documents three architectural ablations..."
This appendix documents two architectural ablations that motivated the
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/dh-sweep_7-12-13.pdf}
    \caption{%
        ...
        At $d_h = 4$, the Adam--iFOPNG gap is $14.0$~pp, but
        ...
        At $d_h = 8$, the gap widens to $23.5$~pp and variance
        ...
        At $d_h = 16$, projection methods partially recover ---
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/beta-chunk-sweep_16-17-18.pdf}
    \caption{%
