...
\section*{Appendix C: Additional Experiment Figures}
...
% ── C.1  Per-task accuracy matrix — Split-CIFAR10 HN ─────────────────────────
...
% ── C.3  SGD first-task convergence threshold ─────────────────────────────────
...
% ── C.4  EMA vs MAX per-seed comparison ──────────────────────────────────────
