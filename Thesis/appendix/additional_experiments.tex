...
This appendix collects seven figures that are referenced in the Results section
...
\begin{figure}[H]
    ...
    \caption{%
        ...
        hypernetwork (10 tasks, standard capacity), $n = 3$ seeds per rate.}
...
% ── D.7  Seed-2137 initialization failure — Split-MNIST HN ──────────────────
