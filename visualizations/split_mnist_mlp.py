...
ewc_data = np.array([
    [0.999, 0.505, 0.476, 0.518, 0.517],  # after task 1
    [0.974, 0.990, 0.318, 0.485, 0.508],  # after task 2
    [0.948, 0.986, 0.998, 0.480, 0.509],  # after task 3
    [0.957, 0.720, 0.989, 0.998, 0.491],  # after task 4
    [0.994, 0.924, 0.990, 0.997, 0.986],  # after task 5
])

fopng_data = np.array([
    [0.999, 0.495, 0.476, 0.450, 0.509],  # after task 1
    [1.000, 0.972, 0.476, 0.493, 0.509],  # after task 2
    [1.000, 0.964, 0.994, 0.413, 0.501],  # after task 3
    [1.000, 0.929, 0.976, 0.996, 0.555],  # after task 4
    [0.999, 0.909, 0.991, 0.979, 0.983],  # after task 5
])

adam_data = np.array([
    [0.999, 0.427, 0.453, 0.572, 0.575],  # after task 1
    [0.537, 0.993, 0.476, 0.520, 0.520],  # after task 2
    [0.463, 0.412, 0.998, 0.482, 0.352],  # after task 3
    [0.461, 0.802, 0.423, 0.998, 0.509],  # after task 4
    [0.537, 0.637, 0.350, 0.561, 0.985],  # after task 5
])
